      ...
      <nav class="navbar"><!-- навигационное меню: 
        ...
        <div class="form-container">
            <form action="" method="post">
                ...
                <input type="text" name="T_numurs_pardevejs" placeholder="Telefona numurs (Nav obligāts)" > <!--Это текстовое поле требует от пользователя ввести ссылку на фотографию на товара.  "placeholder" указывает, что ожидается ввод названия товара.-->
                <textarea name="Apraksts" placeholder="Apraksts (Nav obligāts)"  style="height: 200px;"></textarea> <!--Эта строка создает текстовое поле для ввода ос продукта. Высота 200 пикселей-->
