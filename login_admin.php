...
<body>
   ...
   <header>
      ...
      <nav class="navbar"><!-- навигационное меню: 
          ...
          <a href="#" class="active"><i class="fa-solid fa-user-lock"></i></a><!--ссылка на страницу выхода из административной панели с иконкой.  "Актирная"-->
      </nav>
  </header>
   ...
   <div class="form-container">
      ...
      ?>
         <input type="email" name="E_pasts" required placeholder="E-pasts"> <!--  поле для ввода e-mail адреса пользователя, обязательное для заполнения, с подсказкой "E-pasts" внутри поля.-->
         <input type="password" name="Parole" required placeholder="Parole"> <!--  поле для ввода пароля, обязательное для заполнения, с подсказкой "Parole" внутри поля. Введенный текст скрыт символами звездочек или точек. -->
